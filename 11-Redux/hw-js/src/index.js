...
//incremento y decremento son constantes en las que declare las action creators
...
function renderContador() {
  // Obtenemos la propiedad 'contador' de nuestro store:
    ...
    //store.getState() es para traer todo el estado
    //contador es una prop del estado
